...
//         return (
//             // <table className="libraryContainer justify-content-center">
//             //     <thead>
//             //         <tr className="rowContent headerRow flex-nowrap">
//             //             <th className="rowContent">
//             //                 <div className="genericTextContent secondaryText rowContent headerIndex" style={{width:"2rem", textAlign:"right"}}>
//             //                     #
//             //                 </div>
//             //             </th>
//             //             <th className="rowContent genericTextContent secondaryText">
//             //                 TITLE
//             //             </th>
//             //             <th className="rowContent genericTextContent secondaryText">
//             //                 ALBUM
...
//             //     </thead>
//             // </table>
//             <div className='headersEQW'>
//                 <div className='d-flex align-items-center' aria-colindex="1" tabindex="-1">
//                     #
//                 </div>
                
//             </div>

//             // <Container className="libraryContainer justify-content-center d-table">
//             //     <Row className="rowContent headerRow d-table-row">
//             //         <Col md="auto" className="rowContent d-table-cell">
//             //             <div className="genericTextContent secondaryText rowContent headerIndex d-table-cell" style={{width:"2rem", textAlign:"right"}}>
//             //                 #
//             //             </div>
//             //         </Col>
//             //         <Col md="4" className="rowContent genericTextContent secondaryText d-table-cell">
//             //             TITLE
//             //         </Col>
//             //         <Col md="3" className="rowContent genericTextContent secondaryText d-table-cell">
//             //             ALBUM
//             //         </Col>
//             //         <Col md="2" className="rowContent genericTextContent secondaryText d-table-cell">
//             //             NOTES (HOVERABLE)
//             //         </Col>
//             //         <Col md="auto" className="rowContent genericTextContent secondaryText d-table-cell">
//             //             TAGS (HOVERABLE)
//             //         </Col>
