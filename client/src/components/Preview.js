...
function Preview() {
  ...
  // var [heightTest, set_height_test] = useState(-1);
  ...
  <div>
    ...
    <Container id='dashboard'>
      ...
      - Updates the selected passage (timing/notes/tags), will not overwrite notes or tags if new inputs are empty
          ...
          handleTrackChange={handleTrackChange} /></div>            
    </Container>
  </div> 
  ...
  // Can be cleaned up by using placeholders in place of the svg code, no time to that now
